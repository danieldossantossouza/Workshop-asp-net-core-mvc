...
namespace SalesWebMvc_01.Services
{
	public class SellerService
	{
		...
		{
			return await _context.Seller.ToListAsync(); //Operação Asíncrona
		}
		...
		public async Task RemoveAsync(int id)
		{
			...
			{
				throw new IntegrityException("Não se pode deletar vendedor(a) com vendas cadastrada.");
			}
		}

		public async Task UpddateAsync(Seller obj)
		{
